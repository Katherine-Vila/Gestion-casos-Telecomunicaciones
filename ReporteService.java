 ...
 * solicitud → análisis → asignación (código del caso) → bitácora → finalizar → aprobar.
...
public final class DemoFlujoCompleto {
    ...
    public static void ejecutar() {
        ...
        try {
            ...
            // 3) Solicitud inicial: EN_ESPERA, aún sin código
            System.out.println("\n[3] Solicitar caso (descripción + depto + solicitante)…");
            ...
            System.out.println("\n[4] Analizar caso (carga para decisión del jefe de desarrollo)…");
            System.out.println("     Estado al analizar: " + servicio.analizarCaso(casoId).getEstado());

            // 5) Aceptación: genera código PRS…, asigna roles y fecha límite → EN_DESARROLLO
            Calendar cal = Calendar.getInstance();
            cal.add(Calendar.DAY_OF_MONTH, 14);
            Date fechaLimite = cal.getTime();
            System.out.println("\n[5] Asignar programador, análisis, probador y fecha límite…");
            ...
            // 6) Bitácora + porcentaje
            System.out.println("\n[6] Registrar bitácora (avance)…");
            ...
            // 8) Aprobación del probador → FINALIZADO + fecha de puesta en producción
            System.out.println("\n[8] Aprobar caso (fecha de puesta en producción)…");
