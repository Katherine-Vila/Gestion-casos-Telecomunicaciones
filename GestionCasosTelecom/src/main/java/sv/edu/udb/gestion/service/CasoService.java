...
public class CasoService {
    ...
    // ---------- 1) Pedir caso (solo queda "en espera"; todavia no hay codigo oficial) ----------

    /**
     * El jefe de area pide abrir un caso: se guarda la descripcion y queda {@code EN_ESPERA}.
     * El codigo tipo PRS... se genera despues, cuando desarrollo acepta y asigna ({@link #asignarProgramador}).
     *
    ...
    // El jefe de desarrollo dice "no" al pedido inicial: queda RECHAZADO y se guarda el porque.
    ...
    // El jefe de desarrollo acepta: aqui nace el codigo PRS..., se elige programador, fecha limite y probador.
    ...
    // ---------- 4) Bitacora: solo anota trabajo y porcentaje; no "cierra" el caso sola ----------


    // El programador escribe que hizo y que tanto lleva (0 a 100). No pasa a "esperando aprobacion" solo por llegar al 100%.
    ...
    // ---------- 5) Cuando el programador dice "ya termine mi parte" ----------
     ...
     *       si {@code hoy} es posterior a ese dia y el caso sigue en desarrollo -> VENCIDO.</li>
     *   <li><b>DEVUELTO</b>: 7 días naturales desde la fecha de devolución (solo fecha);
     *       el dia 7 del plazo sigue siendo valido; si {@code hoy} es posterior a ese ultimo dia -> VENCIDO.</li>
     * </ul>
     */
    ...
    /**
     * Acceso para UI (punto 2/3): obtiene el caso por ID.
     */
