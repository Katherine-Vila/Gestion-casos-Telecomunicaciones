...
public class App {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(" 1) Jefe de area pide el caso -> queda EN_ESPERA (todavia sin codigo PRS...).");
        System.out.println(" 2) Jefe de desarrollo revisa la solicitud: la rechaza o la acepta.");
        System.out.println(" 3) Si acepta: se genera el codigo, se asigna programador, fecha limite y probador -> EN_DESARROLLO.");
        System.out.println(" 4) El programador escribe la bitacora y el % de avance (puede repetir varias veces).");
        System.out.println(" 5) Cuando termina su parte, finaliza el caso -> ESPERANDO_APROBACION.");
        System.out.println(" 6) El probador aprueba (con fecha de puesta en produccion) o devuelve con observaciones (7 dias para corregir).");
        System.out.println(" 7) Si vence la fecha limite en desarrollo, o el plazo de 7 dias en devuelto, el sistema puede marcar VENCIDO.");
        System.out.println();
